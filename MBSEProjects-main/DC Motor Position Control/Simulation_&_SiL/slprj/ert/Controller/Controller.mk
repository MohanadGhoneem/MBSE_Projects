...
## Generated on : Wed Jun 29 00:40:15 2022
## Final product: ./Controller_rtwlib.lib
...
MODELLIB                  = Controller_rtwlib.lib
...
%.obj : $(START_DIR)/slprj/ert/Controller/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/ert/Controller/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Controller.obj : $(START_DIR)/slprj/ert/Controller/Controller.c
	$(CC) $(CFLAGS) -o "$@" "$<"
