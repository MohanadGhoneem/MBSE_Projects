...
## Generated on : Wed Jun 29 01:02:25 2022
...
START_DIR                 = C:/Users/Mohand/Desktop/MBSE/DC_Motor_Position_Control/Controller_Code_Generation
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SHAREDLIB_LDFLAGS = -shared -Wl,--no-undefined -Wl,--out-implib,$(basename $(PRODUCT)).lib -g

CPPFLAGS = -c $(CPP_STANDARD_OPTS) -m64 -O0 -g

CPP_LDFLAGS = -static -m64 -g

CPP_SHAREDLIB_LDFLAGS = -shared -Wl,--no-undefined -Wl,--out-implib,$(basename $(PRODUCT)).lib -g
...
DEFINES_STANDARD = -DMODEL=Controller -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.obj : $(START_DIR)/Controller_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
rt_malloc_main.obj : $(MATLAB_ROOT)/rtw/c/src/common/rt_malloc_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
